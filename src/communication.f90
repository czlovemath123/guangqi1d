...
subroutine calculate_irrad_tau()
    integer :: i,n_internal,n_external
    call blk_traversal(irradiation_dtau)
    n_internal=maxval(np_nblk)
    do i=1,np
        call communicate_tau_internal_1d(n_internal)
        call communicate_tau_external_1d()
    end do
end subroutine calculate_irrad_tau
...
subroutine communicate_fld()
    !communicate Erad and sigma, to calculate conductivity
...
subroutine communicate_fld2()
    !communicate Erad_int to calculate Frad
    call communicate_fld2_internal_1d()
    call communicate_fld2_external_1d()
end subroutine communicate_fld2

!subroutine communicate_conductivity()
!end subroutine communicate_conductivity

subroutine assemble_communication_pattern()
    type(blockdef), pointer :: blk
    integer :: i,j,k
    if (lirradiation) call assemble_tau_communication_pattern()
end subroutine assemble_communication_pattern

subroutine assemble_tau_communication_pattern()
    !the communication of tau is asymmetric
    type(blockdef), pointer :: blk
    integer :: i,j,k
end subroutine assemble_tau_communication_pattern

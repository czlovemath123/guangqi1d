...
def plot_figure(models):
    ...
    #axes[0,0].plot(models[1].t,v[:,1]/1e5,'k--')
    ...
    axes[1,0].plot(models[0].t,vkin[:,0]/1e5,'k-',label='shock')
    #axes[1,0].plot(models[1].t,vkin[:,1]/1e5,'k--',label='shock-free')
    ...
    #axes[2,0].plot(models[1].t,temp[:,1]/1e5,'k--',label=r'$T_{\rm{outflow}}$')
    ...
    #axes[0,1].plot(models[1].t,mdot[:,1],'k--',label=r'$\dot{m}_{\rm{outflow}}$')
    ...
    #axes[1,1].plot(models[1].t,culmdot[:,1],'k--',label=r'$\dot{m}_{\rm{outflow}}$')
    axes[1,1].axvspan(0,1.3,alpha=0.5,color='orange')
    axes[1,1].set_ylim(-0.001,0.051)
    axes[1,1].set_ylabel(r'$\Delta M\ [M_{\odot}]$')
    axes[2,1].plot(models[0].t,eradeg[:,0],'k-',label=r'$E_{\rm{rad}}/E_{\rm{g}}$')
    #axes[2,1].plot(models[1].t,eradeg[:,1],'k--',label=r'$E_{\rm{rad}}/E_{\rm{g}}$')
    axes[2,1].axvspan(0,1.3,alpha=0.5,color='orange')
    axes[2,1].set_ylabel(r'$E_{r}/e_{\rm{g}}$')
